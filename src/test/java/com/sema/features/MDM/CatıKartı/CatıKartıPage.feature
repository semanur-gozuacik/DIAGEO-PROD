...
Feature: KPI Management Test Cases
  ...
  Scenario: Çatı Kartı Reset Button Control
    And The user enters "DIAGEOEVENT" into "Fletum Kimlik" filter text input box
  ...
  Scenario: Çatı Kartı page edit verify
    And The user enters "Test Çatı Kartı" into "Fletum Kimlik" filter text input box
  ...
  Scenario:Çatı Kartıct edit -Categories Tab
    And The user enters "Test Çatı Kartı" into "Fletum Kimlik" filter text input box
    And The user clicks on Edit Button
    And The user clicks "İlgili Etkinlik" tab

  Scenario:Çatı edit - Özellikler Tab
    And The user enters "Test Çatı Kartı" into "Fletum Kimlik" filter text input box
    And The user clicks on Edit Button
    And The user clicks "Özellikler" tab

  Scenario:Çatı Group Permission Verify Item First Page Button Unclickable Condition
    And The user enters "Test Çatı Kartı" into "Fletum Kimlik" filter text input box
    And The user clicks on Edit Button
    And clicks group permission tab
    #And  The user verifies previous button is not clickable asset

  Scenario:Çatı Group Permission Verify Item Previous Page Button Unclickable Condition
    And The user enters "Test Çatı Kartı" into "Fletum Kimlik" filter text input box
    And The user clicks on Edit Button
    And clicks group permission tab
    And  The user verifies previous page button is not clickable asset

  Scenario:Çatı Group Permission Verify Last Page Button clickable Condition
    And The user enters "Test Çatı Kartı" into "Fletum Kimlik" filter text input box
    And The user clicks on Edit Button
    And clicks group permission tab
  ...
  Scenario:Çatı Group Permission Verify Last Page Button Unclickable Condition
    And The user enters "Test Çatı Kartı" into "Fletum Kimlik" filter text input box
    And The user clicks on Edit Button
    And clicks group permission tab
    When The user clicks last page button asset
  ...
  Scenario:Çatı Group Permission Verify Item next Button unclickable Condition
    And The user enters "Test Çatı Kartı" into "Fletum Kimlik" filter text input box
    And The user clicks on Edit Button
    And clicks group permission tab
    When The user clicks last page button asset
  ...
  Scenario:Çatı Group Permission Verify Item First Page Button Clickable Condition
    And The user enters "Test Çatı Kartı" into "Fletum Kimlik" filter text input box
    And The user clicks on Edit Button
    And clicks group permission tab
    When The user clicks last page button asset
  ...
  Scenario:Çatı User Permission Verify Item First Page Button Unclickable Condition
    And The user enters "Test Çatı Kartı" into "Fletum Kimlik" filter text input box
    And The user clicks on Edit Button
  ...
  Scenario:Çatı User Permission Verify Item Previous Page Button Unclickable Condition
    And The user enters "Test Çatı Kartı" into "Fletum Kimlik" filter text input box
    And The user clicks on Edit Button
    And clicks user permission tab
  ...
  Scenario:Çatı User Permission Verify Item next Button clickable Condition
    And The user enters "Test Çatı Kartı" into "Fletum Kimlik" filter text input box
    And The user clicks on Edit Button
    And clicks user permission tab
  ...
  Scenario:Çatı User Permission Verify Last Page Button clickable Condition
    And The user enters "Test Çatı Kartı" into "Fletum Kimlik" filter text input box
    And The user clicks on Edit Button
    And clicks user permission tab
  ...
  Scenario:Çatı User Permission Verify Last Page Button Unclickable Condition
    And The user enters "Test Çatı Kartı" into "Fletum Kimlik" filter text input box
    And The user clicks on Edit Button
    And clicks user permission tab
    When The user clicks last page button user
  ...
  Scenario:Çatı User Permission Verify Item next Button unclickable Condition
    And The user enters "Test Çatı Kartı" into "Fletum Kimlik" filter text input box
    And The user clicks on Edit Button
    And clicks user permission tab
    When The user clicks last page button user
  ...
  Scenario:Çatı User Permission Verify Item First Page Button Clickable Condition
    And The user enters "Test Çatı Kartı" into "Fletum Kimlik" filter text input box
    And The user clicks on Edit Button
    And clicks user permission tab
    When The user clicks last page button user

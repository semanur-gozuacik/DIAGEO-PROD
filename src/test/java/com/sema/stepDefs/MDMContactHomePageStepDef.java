...
public class MDMContactHomePageStepDef extends BaseStep {
    ...
    @Then("The user verifies that the codes shown in the {string} label filter are contact categories")
    ...
    @Then("The user clicks on Kurumsal İletişim Filtre")
    public void the_user_clicks_on_kurumsal_iletişim_filtre() {
        pages.contactHomePage().selectKurumsalİletişimFilter();
    }
    ...
    public void the_user_clicks_on_editButton() {
        BrowserUtils.adjustScreenSize(42,Driver.getDriver());
    ...
    public void theUserNavigateTo(String url) {
        pages.contactHomePage().navigateTo(url);
    }

    @And("The user clicks on {string}")
    public void theUserClicksOn(String subcategories) {
        pages.contactHomePage().clickSubCategories(subcategories);
    }

    @And("The user clicks on Reserve Filtre")
    public void theUserClicksOnReserveFiltre() {
        pages.contactHomePage().selectReserveFamilyFilter();
    }

    @And("the user verify on family filter Reserve functionality")
    public void theUserVerifyOnFamilyFilterReserveFunctionality() {
        pages.contactHomePage().selectReserveFamilyFilter();
    }
    ...
    public void theUserVerifyOnFamilyFilterPazarlamaFunctionality() {
    }
}